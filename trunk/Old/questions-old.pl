...
wh(sem:[lf:W,type:T,con:G]) --> 
	relp(sem:[lf:W,type:T,con:G],syn:[t:c]).


wh(sem:[lf:W,type:T,con:G]) --> 
	relp(sem:[lf:P,type:T1,con:G1],syn:[t:c]),
...
/*
wh(sem:[lf:W1,type:T,con:G]) -->
	relp(sem:[lf:R,type:TR,con:GR],syn:[t:c]),
	noun(sem:[lf:N,type:TN,con:GN]),
	conj(sem:[lf:C,type:TC,con:GC],syn:[t:full]),
	wh(sem:[lf:W,type:TW,con:GW]),
	{logform(C,W,L1),
	 f_app(GC,TC,GW,TW,G1,T1),
	 logform(L1,N,L2),
	 f_app(G1,T1,GN,TN,G2,T2),
	 logform(R,L2,W1),
	 f_app(G2,T2,GR,TR,G,T)}.
*/
...
% (there is only positive polarity components!)
...
% (a nominal is a noun or something more complex!)
...
noun(sem:[lf:N,type:T,con:G]) -->
	nounc(sem:[lf:NN,type:TN,con:GN]),
	relp(sem:[lf:P,type:T1,con:G1],syn:[t:b]),
	s(sem:[lf:S,type:T2,con:G2],syn:[gap:yes,ass:cq]),
	{abs_f(S,SS),
	 f_abs(G2,T2,GG,TT),
	 logform(P,SS,PP),
	 f_app(G1,T1,GG,TT,GR,TR),
	 logform(PP,NN,N),
	 f_app(GR,TR,GN,TN,G,T)}.
...
% 6. Adjectives (qualificative):


adj(sem:[lf:A,type:T,con:G],syn:[t:qual]) -->
	conj(sem:[lf:C,type:TC,con:GC],syn:[t:full]),
	adj(sem:[lf:A1,type:TA,con:GA],syn:[t:qual]),
	{logform(),
	 f_app()}.
