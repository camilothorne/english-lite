...
:- module(cq2tptp,[fol2tptp/2,fol2tptp2/2]).
...
fol2tptp(Formula,Stream):- 
   write(Stream,'fof(comsem,conjecture,'),
   \+ \+ ( numbervars(Formula,0,_),printTptp(Formula,Stream) ),
   write(Stream,').'),
   nl(Stream).

fol2tptp2(Formula,Stream):- 
   write(Stream,'fof(comsem,axiom,'),
   \+ \+ ( numbervars(Formula,0,_),printTptp(Formula,Stream) ),
   write(Stream,').'),
   nl(Stream).
...
printTptp(lam(X,Formula),Stream):- !,
   write(Stream,'(? ['),
